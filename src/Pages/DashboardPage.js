...
dispatch(deleteProject({projId:projectId,uId:userId}))
  ...
  return (
    <div className="p-8 text-center w-{100%}"> 
    <div className='flex justify-between w-{100%}'><h2 className="my-8 mr-64 text-3xl"> Your projects</h2>
    {/* Button for Add - className='rounded-md bg-amber-400 px-3 ml-3'*/}
     {/* <div className=' flex float-right'></div>  */}

    <Link to='/addproject'>  <button className=' my-8 float-right font-bold rounded-md bg-red-500 px-8 -mr-96'> ADD PROJECT
 </button></Link></div>
